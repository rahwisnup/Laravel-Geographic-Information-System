...
@section('breadcrumb1')
    <a href="{{route('trees.list')}}">Tree</a>
@endsection
                                ...
                                <tbody>
                                    @foreach ($trees as $tree)
                                        <tr class="tr-shadow">
                                            ...
                                            <td>{{$index=$index+1}}</td>
                                            <td>
                                                <span class="block-email">{{$tree->treeMaster['name']}}</span>
                                            </td>
                                            <td>{{$tree->area['name']}}</td>
                                            <td>{{$tree->sides['name']}}</td>
                                            <td>{{$tree->treeCategories['name']}}</td>
                                            <td>
                                                <td>
